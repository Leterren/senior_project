...
class GameWindow < Gosu::Window
  ...
  def draw
    ...
    img.draw_rot(100, 340, ZOrder::Star, -90, 0, 0, 3.0, 3.0, 0xff99dd33)
    #img.draw_rot(100, 340, ZOrder::UI, 90, 1, 1, 3.0, 3.0, 0xff22ff00)
    

    # use draw_quad to draw some example shots
    x = 400
    y = 120
    draw_quad(x - 40, y - 40, 0xff00ff00, 
              x + 40, y - 40, 0xffffff00, 
              x - 40, y + 40, 0xffff0000, 
              x + 40, y + 40, 0xff0000ff, ZOrder::Shot)
    ...
    # use draw_rot method to draw rotating image of shield
