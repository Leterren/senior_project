...
class Tplayer
  ...
  def try_attack (tox, toy)
	...
	def draw
  	...
  	@game.main_font.draw("Moves Left:", 630, @game.height/4 - 50, ZOrder::HUD, 1, 1, 0xFF888888)
	@game.main_font.draw("#{@move_max - @current_move}", 730, @game.height/4 - 50, ZOrder::HUD, 1, 1, 0xFF6666FF)
